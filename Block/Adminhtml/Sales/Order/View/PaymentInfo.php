<?php
/**
 * Copyright (c) 2017. All rights reserved Duitku Ovopayment.
 *
 ...
 *
 * @author    Duitku Ovopayment
 * @copyright Duitku Ovopayment (http://duitku.com)
 * @license   Duitku Ovopayment
 *
 */
namespace Duitku\Ovo\Block\Adminhtml\Sales\Order\View;

use Duitku\Ovo\Model\Method\Epay\Payment as EpayPayment;
...
class PaymentInfo extends \Magento\Backend\Block\Template
{
     ...
     * @param \Duitku\Ovo\Helper\Data $duitkuHelper
     * @param array $data
     */
    public function __construct(
        ...
        \Duitku\Ovo\Helper\Data $duitkuHelper,
        array $data = []
    ) {
     ...
     *
     * @param \Duitku\Ovo\Model\Api\Checkout\Response\Models\Transaction $transaction
     * @return string
     */
     ...
     *
     * @param \Duitku\Ovo\Model\Api\Epay\Response\Models\TransactionInformationType $transactionInformation
