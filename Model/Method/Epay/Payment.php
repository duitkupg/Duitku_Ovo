 ...
 *
 */
namespace Duitku\Ovo\Model\Method\Epay;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\Ovo\Helper\DuitkuConstants;

class Payment extends \Duitku\Ovo\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_ovoepay';
    const METHOD_REFERENCE = 'duitkuovoReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Ovo\Block\Info\View';
    ...
    /**
     * @var \Duitku\Ovo\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Ovo\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Ovo\Model\Api\Epay\Request\Payment
     */
    ...
    $callbackUrl = $this->_urlBuilder->getUrl('duitku/epayovo/callback?isAjax=true&form_key='.$FormKey->getFormKey());
     ...
     * @return \Duitku\Ovo\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayovo/checkout', ['_secure' => $this->_request->isSecure()]);
    }
